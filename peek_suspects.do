...
use category year product_desc clean_desc price qty similarity_score ///
    ...
    inlist(category, "cell culture antibiotics - zeocin", "direct pcr lysis reagents", "colorimetric substrates - dab", "crystallizing dishes", "carbon dioxide", "lds sample buffer"), clear
...
display _newline "=== SUSPECT ITEMS BY CATEGORY ==="
...
list category similarity_score log_price reason product_desc, sep(0) noobs string(80)
