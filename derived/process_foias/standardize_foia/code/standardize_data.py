...
COLUMN_SPECS: Dict[str, Mapping[str, str]] = {
    ...
    "TTU_2010_2025.xlsx": {"product_desc": "Product Description", "supplier": "Supplier Name", "supplier_id": "Supplier ID", "sku": "SKU/Catalog #", "price": "Unit Price", "qty": "Quantity", "purchaser": "Requisitioner", "purchase_id": "PO #", "date": "Creation Date"},
