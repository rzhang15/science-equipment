...
COLUMN_SPECS: Dict[str, Mapping[str, str]] = {
    ...
    "umich_1998_2019.xlsx": {"product_desc": "ITM DESCR254", "supplier": "VENDOR NAME", "supplier_id": "VENDOR ID", "price": "PRICE PO","unit": "UNIT OF MEASURE", "qty": "QTY PO", "spend": "Sum MERCHANDISE AMT", "fund_id": "SPONSOR AWARD", "purchase_id": "PO ID", "date": "PO DT"},
